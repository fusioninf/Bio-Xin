    ...
    Public Class DTS_GetController
        ...
        Public Function CheckPassword(ByVal UserId As String, ByVal Password As String) As HttpResponseMessage
            Try
                ...
                'if oResult.
                'If G_DI_Company.AuthenticateUser(UserId, Password) = SAPbobsCOM.AuthenticateUserResultsEnum.aturBadUserOrPassword Then
                '    dt_Error.Columns.Add("ReturnCode")
                '    dt_Error.Columns.Add("ReturnMsg")
                '    NewRow = dt_Error.NewRow
                '    NewRow.Item("ReturnCode") = "-2222"
                '    NewRow.Item("ReturnMsg") = "Bad User or Password"
                '    dt_Error.Rows.Add(NewRow)
                '    Return Request.CreateResponse(HttpStatusCode.OK, dt_Error)
                'ElseIf G_DI_Company.AuthenticateUser(UserId, Password) = SAPbobsCOM.AuthenticateUserResultsEnum.aturDBErrors Then
                '    dt_Error.Columns.Add("ReturnCode")
                '    dt_Error.Columns.Add("ReturnMsg")
                '    NewRow = dt_Error.NewRow
                '    NewRow.Item("ReturnCode") = "-2222"
                '    NewRow.Item("ReturnMsg") = "DB errors"
                '    dt_Error.Rows.Add(NewRow)
                '    Return Request.CreateResponse(HttpStatusCode.OK, dt_Error)
                'ElseIf G_DI_Company.AuthenticateUser(UserId, Password) = SAPbobsCOM.AuthenticateUserResultsEnum.aturLogOnUserNotAdmin Then
                'End If
                'Qstr = "Select Case When E.""empID"" Is Null Then '-2222' Else '-0000' End As ""ReturnCode"", " & vbNewLine &
                '        "   Case When E.""empID"" Is Null Then 'User credentials are incorrect' Else 'Login successful' End As ReturnMsg, " & vbNewLine &
                '        "    Case When E.""empID"" Is Null Then '' Else B.""U_EMPLCODE"" End As ""EmpId"",  " & vbNewLine &
                '        "    Case When E.""empID"" Is Null Then '' Else B.""U_USRTYPE"" End As ""UserType"" " & vbNewLine &
                '        "   From ""OADM"" A " & vbNewLine &
                '        "       Left Outer Join ""@ESPL_MD_USRMSTR"" B On B.""Code"" ='" + UserId + "' And IFNULL(B.""U_PASSWORD"", '') = '" + Password + "' AND B.""U_ACTIVE"" ='Y' " & vbNewLine &
                '        "      LEFT OUTER JOIN ""OHEM"" E ON E.""empID""=B.""U_EMPLCODE"" AND ""Active""='Y' ; "


                'Dim dt_DataRow As Data.DataRow
                'dt_DataRow = DBSQL.getQueryDataRow(Qstr, "")
                'If dt_DataRow.Item(0) = "-2222" Then
                '    dt_Error.Columns.Add("ReturnCode")
                '    dt_Error.Columns.Add("ReturnMsg")
                '    NewRow = dt_Error.NewRow
                '    NewRow.Item("ReturnCode") = "-2222"
                '    NewRow.Item("ReturnMsg") = "User credentials are incorrect"
                '    dt_Error.Rows.Add(NewRow)
                '    Return Request.CreateResponse(HttpStatusCode.OK, dt_Error)
                'End If
        ...
        Public Function GetUserWiseMenuDetails() As HttpResponseMessage
            ...
            'dtTable.Columns.Add("ReturnMsg")
            'NewRow = dtTable.NewRow
            'NewRow.Item("ReturnCode") = Branch
            'NewRow.Item("ReturnMsg") = UserID
            'dtTable.Rows.Add(NewRow)
            'Return Request.CreateResponse(HttpStatusCode.OK, dtTable)
        ...
        Public Function GetSalesOrderHeader(Optional ByVal BuisnessUnit As String = "", Optional ByVal DocEntry As String = "",
                                            ...
                                            Optional ByVal DocNo As String = "") As HttpResponseMessage
            ...
            HanaDbCommand_SP.Parameters.AddWithValue("P_CardCode", IIf(CardCode Is Nothing, "", CardCode))
            HanaDbCommand_SP.Parameters.AddWithValue("P_DocStatus", IIf(DocStatus Is Nothing, "", DocStatus))
            'HanaDbCommand_SP.Parameters.AddWithValue("P_ToBranch", IIf(ToBranch Is Nothing, IIf(BuisnessUnit Is Nothing, "", BuisnessUnit), IIf(ToBranch = "", BuisnessUnit, ToBranch)))
            HanaDbCommand_SP.Parameters.AddWithValue("P_CardName", IIf(CardName Is Nothing, "", CardName))
        ...
        <HttpGet>
        Public Function InvoiceForServiceGain(Optional ByVal DocEntry As String = "", Optional ByVal BusinessUnit As String = "") As HttpResponseMessage
        ...
        Public Function GetECommerceCorrierTrackHeader(Optional ByVal BuisnessUnit As String = "", Optional ByVal DocEntry As String = "",
            ...
            If Not Mod_Main.Authenticate(Request, UserID, Branch, dtError) Then
                Return Request.CreateResponse(HttpStatusCode.OK, dtError)
            End If
            Dim HanaDbCommand_SP As HanaCommand = New HanaCommand("DTS_SP_ECommerceCorrierTrackHeader")
            HanaDbCommand_SP.CommandType = Data.CommandType.StoredProcedure
            HanaDbCommand_SP.Parameters.AddWithValue("P_Branch", Branch)
            HanaDbCommand_SP.Parameters.AddWithValue("P_User", IIf(UserCode Is Nothing, "", UserCode))
            HanaDbCommand_SP.Parameters.AddWithValue("P_DocEntry", IIf(DocEntry Is Nothing, "", DocEntry))
